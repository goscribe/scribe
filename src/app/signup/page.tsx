...
import { Brain, BookOpen, Headphones, FileText, Sparkles, Mail, Lock, User, ArrowLeft } from "lucide-react";
...
export default function SignupPage() {
  ...
  const { mutate: signupMutation, isPending: isLoading, error: signupError } = trpc.auth.signup.useMutation();
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-muted-foreground">
            Join Scribe and start your learning journey
          </p>
        </div>
