...
export function usePusherPodcast(workspaceId: string) {
  ...
  useEffect(() => {
    ...
    channelRef.current.bind(`${workspaceId}_podcast_structure_complete`, (data: PodcastStructureCompleteData) => {
      console.log('Podcast structure complete:', data);
      setState(prev => ({
        ...prev,
        progress: {
          ...prev.progress,
    ...
    channelRef.current.bind(`${workspaceId}_podcast_audio_generation_start`, (data: PodcastAudioGenerationStartData) => {
      console.log('Podcast audio generation started:', data);
      setState(prev => ({
        ...prev,
        progress: {
          ...prev.progress,
    ...
    channelRef.current.bind(`${workspaceId}_podcast_segment_progress`, (data: PodcastSegmentProgressData) => {
      console.log('Podcast segment progress:', data);
      setState(prev => ({
        ...prev,
        progress: {
          ...prev.progress,
    ...
    channelRef.current.bind(`${workspaceId}_podcast_audio_generation_complete`, (data: PodcastAudioGenerationCompleteData) => {
      console.log('Podcast audio generation complete:', data);
      setState(prev => ({
        ...prev,
        progress: {
          ...prev.progress,
    ...
    channelRef.current.bind(`${workspaceId}_podcast_audio_preparation_complete`, (data: PodcastAudioPreparationCompleteData) => {
      console.log('Podcast audio preparation complete:', data);
      setState(prev => ({
        ...prev,
        progress: {
          ...prev.progress,
    ...
    channelRef.current.bind(`${workspaceId}_podcast_summary_complete`, (data: PodcastSummaryCompleteData) => {
      console.log('Podcast summary complete:', data);
      setState(prev => ({
        ...prev,
        progress: {
          ...prev.progress,
    ...
    channelRef.current.bind(`${workspaceId}_podcast_ended`, (data: PodcastGenerationCompleteData) => {
    ...
    channelRef.current.bind(`${workspaceId}_podcast_segment_regeneration_start`, (data: PodcastSegmentRegenerationStartData) => {
      console.log('Segment regeneration started:', data);
      setState(prev => ({
        ...prev,
        regeneratingSegments: {
    ...
    channelRef.current.bind(`${workspaceId}_podcast_segment_audio_updated`, (data: PodcastSegmentAudioUpdatedData) => {
      console.log('Segment audio updated:', data);
    ...
    channelRef.current.bind(`${workspaceId}_podcast_segment_regeneration_complete`, (data: PodcastSegmentRegenerationCompleteData) => {
      console.log('Segment regeneration complete:', data);
      setState(prev => ({
        ...prev,
        regeneratingSegments: {
          ...prev.regeneratingSegments,
    ...
    channelRef.current.bind(`${workspaceId}_podcast_deletion_start`, (data: PodcastDeletionStartData) => {
      console.log('Episode deletion started:', data);
      setState(prev => ({
        ...prev,
        deletingEpisodes: {
    ...
    channelRef.current.bind(`${workspaceId}_podcast_deletion_complete`, (data: PodcastDeletionCompleteData) => {
      console.log('Episode deletion complete:', data);
      setState(prev => ({
        ...prev,
        deletingEpisodes: {
          ...prev.deletingEpisodes,
